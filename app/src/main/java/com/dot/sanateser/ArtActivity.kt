    ...
    fun selectImage(view: View){
        ...
        if(ContextCompat.checkSelfPermission(this,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
             if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                //rationale
                 Snackbar.make(view,"Galeriye gitmek içib izin vermeniz lazım Haştmetlim",Snackbar.LENGTH_INDEFINITE).setAction("İzin ver",View.OnClickListener {
                     //request permission
    ...
    private fun registerLauncher(){
        ...
        permissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()){result ->
            if (result){
                ...
                Toast.makeText(this@ArtActivity,"İZİN VERMENİZ LAZIM HAŞMETLİM",Toast.LENGTH_LONG).show()
            }
        }
